 ...
 * @LastEditors: 郭印林
 * @LastEditTime: 2022-08-11 16:24:38
-->
...
encoder和decoder之间的attention采用了 Triggered attention 来实现流式。TA训练需要编码器状态序列 $X_e$ 和标签序列 $Y=(y_1,\dots, y_L)$ 之间的对齐，以仅在过去的编码器帧加上固定数量的 look-ahead 帧 $\epsilon^{dec}$ 上调节解码器的注意机制。